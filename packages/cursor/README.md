...
| `diff-review.md`             | `/diff-review`             | Quality     | ステージング済み変更のセルフレビュー                   |
| `pr-review.md`               | `/pr-review`               | Quality     | GitHub PR のレビューと指摘対応の検討                   |
| `magi-pr-review.md`          | `/magi-pr-review`          | Quality     | MAGI 3体合議による多角的 PR レビュー                   |
