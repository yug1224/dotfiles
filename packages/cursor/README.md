...
| `graphic-record-prompt.md`   | `/graphic-record-prompt`   | Visual      | PR・ADR・開発ログから Gemini Nano Banana Pro 向け画像生成プロンプトを出力 |
...
RTK 前提・セットアップ・stow 衝突: [`packages/shared/shared/ai/docs/RTK.md`](../shared/shared/ai/docs/RTK.md)。`hooks/guard-shell.sh` は共有本体 [`packages/shared/shared/ai/hooks/guard-shell.sh`](../shared/shared/ai/hooks/guard-shell.sh) へ `exec` 委譲する。
...
`rtk init` 生成物と stow の競合対処: [RTK.md §7](../shared/shared/ai/docs/RTK.md)（`~/.cursor/hooks.json`）。
