...
- 詳細チェックリスト: `packages/shared/ai/rules/checklists/code-review-checklist.md`（make mise 後 `~/.config/shared/ai/rules/` 等。Cursor ラッパー: `code-review-checklist.mdc`）
...
- マルチテナント環境でのデータ分離
- 詳細チェックリスト: `packages/shared/ai/rules/checklists/owasp-top10-checklist.md`（make mise 後 `~/.config/shared/ai/rules/` 等。Cursor ラッパー: `owasp-top10-checklist.mdc`）
...
- 詳細チェックリスト: `packages/shared/ai/rules/checklists/test-strategy-matrix.md`（make mise 後 `~/.config/shared/ai/rules/` 等。Cursor ラッパー: `test-strategy-matrix.mdc`）
