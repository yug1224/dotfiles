...
| 手段 | 内容                                                                                                                                                                                                                                                 |
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 手動 | `wrapper-parity-checklist.md`、`leakage-checklist.md`、ゴールデンパス（registry 参照 cmd、レビュー常時並列・Linus フル敵対）、Worker 委譲・Task `model` 煙テスト（`explore-worker` / `general-worker` を `composer-2.5` または `sonnet` で起動確認） |
