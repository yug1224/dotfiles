...
`packages/shared/shared/ai/rules/conventions/commit-message-rule.md`（または stow 後の `~/.config/shared/ai/rules/conventions/commit-message-rule.md`）を Read ツールで読み込み、コミットメッセージ規約を把握する。
