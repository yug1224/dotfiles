...
RTK 前提・セットアップ・競合対処・guard 判定表: [`packages/shared/shared/ai/docs/RTK.md`](../shared/shared/ai/docs/RTK.md)。`CLAUDE.md` は [`RTK.md`](RTK.md)（shared 正本のラッパー）を常時 import する。
